 ...
 */
final class Version20220404000938 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE recherche (id INT AUTO_INCREMENT NOT NULL, media_contact_id INT NOT NULL, employe_id INT DEFAULT NULL, entreprise_id INT NOT NULL, etudiant_id INT NOT NULL, stage_id INT DEFAULT NULL, dernier_etat_id INT DEFAULT NULL, observations LONGTEXT DEFAULT NULL, INDEX IDX_B4271B46ED84EBDE (media_contact_id), INDEX IDX_B4271B461B65292 (employe_id), INDEX IDX_B4271B46A4AEAFEA (entreprise_id), INDEX IDX_B4271B46DDEAB1A3 (etudiant_id), UNIQUE INDEX UNIQ_B4271B462298D193 (stage_id), UNIQUE INDEX UNIQ_B4271B46D21280CB (dernier_etat_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
