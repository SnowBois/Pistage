 ...
 */
final class Version20220224141711 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE adresse (id INT AUTO_INCREMENT NOT NULL, voie VARCHAR(50) NOT NULL, batiment_residence_zi VARCHAR(50) DEFAULT NULL, commune VARCHAR(50) NOT NULL, code_postal VARCHAR(5) NOT NULL, pays VARCHAR(30) NOT NULL, cedex VARCHAR(5) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE entreprise (id INT AUTO_INCREMENT NOT NULL, adresse_id INT NOT NULL, nom VARCHAR(50) NOT NULL, numero_telephone VARCHAR(15) NOT NULL, type_etablissement VARCHAR(30) NOT NULL, activite LONGTEXT NOT NULL, numero_siret VARCHAR(14) NOT NULL, code_apeou_naf VARCHAR(10) DEFAULT NULL, statut_juridique VARCHAR(30) DEFAULT NULL, effectif INT NOT NULL, numero_fax VARCHAR(15) DEFAULT NULL, adresse_mail VARCHAR(100) DEFAULT NULL, site_web VARCHAR(100) DEFAULT NULL, INDEX IDX_D19FA604DE7DC5C (adresse_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE etablissement_enseignement (id INT AUTO_INCREMENT NOT NULL, adresse_id INT NOT NULL, composante_ufr VARCHAR(50) NOT NULL, discipline_et_diplome VARCHAR(30) NOT NULL, etape_etude VARCHAR(30) NOT NULL, numero_telephone VARCHAR(15) NOT NULL, INDEX IDX_D494C94D4DE7DC5C (adresse_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE etat_recherche (id INT AUTO_INCREMENT NOT NULL, recherche_id INT NOT NULL, etat VARCHAR(30) NOT NULL, date DATE NOT NULL, INDEX IDX_44B55DAA1E6A4A07 (recherche_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE etudiant (id INT AUTO_INCREMENT NOT NULL, cursus_id INT NOT NULL, adresse_id INT NOT NULL, nom VARCHAR(30) NOT NULL, prenom VARCHAR(30) NOT NULL, numero_etudiant VARCHAR(10) NOT NULL, adresse_mail VARCHAR(100) NOT NULL, INDEX IDX_717E22E340AEF4B9 (cursus_id), INDEX IDX_717E22E34DE7DC5C (adresse_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE recherche (id INT AUTO_INCREMENT NOT NULL, interlocuteur_id INT DEFAULT NULL, entreprise_id INT NOT NULL, etudiant_id INT NOT NULL, stage_id INT DEFAULT NULL, media_contact VARCHAR(30) NOT NULL, observations LONGTEXT DEFAULT NULL, INDEX IDX_B4271B465DC4D72E (interlocuteur_id), INDEX IDX_B4271B46A4AEAFEA (entreprise_id), INDEX IDX_B4271B46DDEAB1A3 (etudiant_id), UNIQUE INDEX UNIQ_B4271B462298D193 (stage_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE CDs (code INT AUTO_INCREMENT NOT NULL, titre VARCHAR(100) CHARACTER SET latin1 DEFAULT NULL COLLATE `latin1_swedish_ci`, auteurOUgroupe VARCHAR(50) CHARACTER SET latin1 DEFAULT NULL COLLATE `latin1_swedish_ci`, genre VARCHAR(30) CHARACTER SET latin1 DEFAULT NULL COLLATE `latin1_swedish_ci`, prix NUMERIC(10, 2) DEFAULT NULL, cheminSource VARCHAR(100) CHARACTER SET latin1 DEFAULT NULL COLLATE `latin1_swedish_ci`, PRIMARY KEY(code)) DEFAULT CHARACTER SET latin1 COLLATE `latin1_swedish_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE Utilisateurs (login VARCHAR(30) CHARACTER SET latin1 NOT NULL COLLATE `latin1_swedish_ci`, password VARCHAR(30) CHARACTER SET latin1 DEFAULT NULL COLLATE `latin1_swedish_ci`, PRIMARY KEY(login)) DEFAULT CHARACTER SET latin1 COLLATE `latin1_swedish_ci` ENGINE = InnoDB COMMENT = \'\' ');
