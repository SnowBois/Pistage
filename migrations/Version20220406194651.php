 ...
 */
final class Version20220406194651 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE entreprise (id INT AUTO_INCREMENT NOT NULL, adresse_id INT NOT NULL, nom VARCHAR(50) NOT NULL, numero_telephone VARCHAR(20) DEFAULT NULL, type_etablissement VARCHAR(30) DEFAULT NULL, activite LONGTEXT DEFAULT NULL, numero_siret VARCHAR(14) DEFAULT NULL, code_apeou_naf VARCHAR(10) DEFAULT NULL, statut_juridique VARCHAR(30) DEFAULT NULL, effectif VARCHAR(10) DEFAULT NULL, numero_fax VARCHAR(20) DEFAULT NULL, adresse_mail VARCHAR(100) DEFAULT NULL, site_web VARCHAR(100) DEFAULT NULL, INDEX IDX_D19FA604DE7DC5C (adresse_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
